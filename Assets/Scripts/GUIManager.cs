...
public class GUIManager : MonoBehaviour
{
    ...
    public void showMemo() {
        ...
        if(playerStats.curShift == 5) { GUI_memo.transform.Find("Memo_Day6").gameObject.SetActive(true); }
    }
    /// <summary>
    ...
    void syncReport() {
        ...
        if(playerStats.curShift == 2) { GUI_Report.transform.Find("ReportText").GetComponent<TextMeshProUGUI>().text = "Looks like you managed to deal with all the extra items today. You did a great job. Every day, you’ll have the option to contribute to the community park. Today’s funds will be going towards building a swing set, if there’s enough."; }
